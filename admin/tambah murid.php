      ...
      <main class="mdl-layout__content mdl-color--white-100">
        <div class="mdl-grid demo-content">
          <div class="demo-charts mdl-color--white  mdl-cell mdl-cell--12-col mdl-grid">
            <!-- Form Tambah Guru-->
            <form role="form"  action="proses tambah murid.php" method="post" name="postform" enctype="multipart/form-data">
                <h4>FORM TAMBAH MURID</h4>
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    <label for="nim" class="mdl-textfield__label">NIM</label>
                    <input type="text" pattern="[0-9]*" class="mdl-textfield__input" name="nim" id="nim"  />
                    <span class="mdl-textfield__error">Format berupa angka</span>
                </div>
                <br>
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    <label for="namadepan" class="mdl-textfield__label">Nama Depan</label>
                    <input id="namadepan" name="namadepan" type="text" pattern="[A-Za-z]*" class="mdl-textfield__input" />
                ...
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    ...
                    <input id="namabelakang" name="namabelakang" type="text" pattern="[A-Za-z]*" class="mdl-textfield__input" />
                    <span class="mdl-textfield__error">Tidak boleh berupa angka atau simbol</span>
                </div>                
                <br>
                <label for="jk1" class="mdl-radio mdl-js-radio mdl-js-ripple-effect">
                    <input type="radio" class="mdl-radio__button" id="jk1" name="jk" value="Pria" checked/>
                    <span class="mdl-radio__label"> Pria </span>
                </label>

                <label for="jk2" class="mdl-radio mdl-js-radio mdl-js-ripple-effect">
                    <input type="radio" class="mdl-radio__button" id="jk2" name="jk" value="Wanita" />
                ...
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label ">
                    ...
                    <textarea name="alamat" id="alamat" class="mdl-textfield__input"></textarea>
                </div>
                <br>
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    <label for="no_telp" class="mdl-textfield__label">No Telp (+62)</label>
                    <input type="text" pattern="[0-9]*" class="mdl-textfield__input" id="no_telp" name="no_telp" />
                ...
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    ...
                    <input type="text" pattern="[A-Z a-z]*" class="mdl-textfield__input" id="nama_ortu" name="nama_ortu" />
                    <span class="mdl-textfield__error">Masukan hanya berupa angka</span>
                </div>
                <br>
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    <label for="telp_ortu" class="mdl-textfield__label">No Telp Ortu (+62)</label>
                    <input type="text" pattern="[0-9]*" class="mdl-textfield__input" id="telp_ortu" name="telp_ortu" />
                    <span class="mdl-textfield__error">Masukan hanya berupa angka</span>
                </div>
                <br>                                
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                ...
                <br>                
                <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent " type="submit">Tambah Siswa</button>
