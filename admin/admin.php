...
<div class="demo-card-event mdl-card mdl-shadow--2dp">
  ...
  <div class="mdl-card__actions mdl-card--border">
    ...
    <i class="material-icons"></i>
		...
		<div class="demo-charts mdl-color--white mdl-shadow--2dp mdl-cell mdl-cell--12-col mdl-grid">
 <form role="form" action="proses edit sekolah.php" method="post" name="postform" enctype="multipart/form-data">
                <h4>Sekolah</h4>
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell--12-col">
                    <label for="nama" class="mdl-textfield__label">Nama</label>
                    <input type="text"class="mdl-textfield__input" id="nama" name="nama" value="<?php echo $nama_sekolah; ?>" />
                </div>
                <br>
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    <label for="alamat" class="mdl-textfield__label">Alamat</label>
                    <input type="text" class="mdl-textfield__input" id="alamat" name="alamat" value="<?php echo $alamat; ?>" />
                </div>
                <br>
				 <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label ">
                    <label for="deskripsi" class="mdl-textfield__label">Deskripsi</label>
                    <textarea name="deskripsi" id="deskripsi" class="mdl-textfield__input"><?php echo $deskripsi;?></textarea>
                </div>
                <br>
